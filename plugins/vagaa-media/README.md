...
| Verified against | **media-mcp 0.7.22** |
...
| Tool surface | media-mcp 0.7.22 serves the **standard** surface only (`/mcp`, 40 tools). `/mcp-compact` is not deployed; use `surface=standard` |
